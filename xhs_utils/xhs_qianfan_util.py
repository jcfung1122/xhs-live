import random
from xhs_utils.xhs_util import generate_x_b3_traceid, generate_xs_xs_common
...
def get_live_invite_headers_template():
    """Headers template for live invite flow (from solar/pre-trade/live/kol page)"""
    return {
        "authority": "pgy.xiaohongshu.com",
        "accept": "application/json, text/plain, */*",
        "accept-language": "zh-CN,zh;q=0.9",
        ...
        "origin": "https://pgy.xiaohongshu.com",
        "pragma": "no-cache",
        "referer": "https://pgy.xiaohongshu.com/solar/pre-trade/live/kol",
        "sec-ch-ua": "\"Chromium\";v=\"122\", \"Not(A:Brand\";v=\"24\", \"Google Chrome\";v=\"122\"",
        "sec-ch-ua-mobile": "?0",
        "sec-ch-ua-platform": "\"Windows\"",
        "sec-fetch-dest": "empty",
...
def generate_qianfan_signed_headers(a1, api, data=''):
    """Generate Draco API headers with x-s/x-s-common/x-t signature"""
